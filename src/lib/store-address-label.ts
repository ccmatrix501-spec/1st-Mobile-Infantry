...
export function printStoreAddressLabel(order: StoreOrder): void {
  ...
  const postcode = clean(rawPostcode);
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .main-row {
      ...
      top: 16.7mm;
      height: 26.8mm;
      border-left: 0.4mm solid #0a0a0a;
      border-right: 0.4mm solid #0a0a0a;
      border-bottom: 0.45mm solid #0a0a0a;
    }
    .emblem-box {
      position: absolute;
      left: 0;
    ...
    .message-row {
      ...
      height: 10.1mm;
      display: grid;
      grid-template-columns: 27.8mm 1fr 31.8mm;
      border-left: 0.4mm solid #0a0a0a;
      border-right: 0.4mm solid #0a0a0a;
      border-bottom: 0.45mm solid #0a0a0a;
    }
    ...
    .supply-stripes {
      ...
      width: 5.5mm;
      height: 7.2mm;
      background: repeating-linear-gradient(120deg, #fff 0 1.4mm, transparent 1.4mm 3mm);
    }
    .footer-row {
      position: absolute;
      left: 1.5mm;
    ...
    .footer-stripes {
      ...
      height: 5.2mm;
      top: 0.7mm;
      background: repeating-linear-gradient(120deg, #0a0a0a 0 2.2mm, transparent 2.2mm 4.6mm);
    }
    ...
    @media screen {
      ...
      .screen-note {
        display: block;
        width: min(120mm, calc(100vw - 32px));
        margin: 12px auto 0;
        color: #222;
        font-size: 12px;
        line-height: 1.4;
...
<body>
  <main class="label">
    <div class="concept-row">
      <span>DESIGN 18 - FIELD-MANUAL STYLE</span>
  ...
  <p class="screen-note">Brother QL-700 test settings: 62 mm continuous roll, label length 120 mm, Landscape, Actual Size / 100%, margins None, browser headers and footers off.</p>
  <script>
